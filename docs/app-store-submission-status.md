...
| # | Item | Status | Notes |
|---|------|--------|-------|
| S1 | Screenshots prepared for iPhone Pro and Pro Max sizes | ✅ Done | 5-shot sets captured in `docs/app-store-screenshots/iPhone 17 Pro/` and `docs/app-store-screenshots/iPhone 17 Pro Max/`; regenerate with `scripts/capture-app-store-screenshots.sh` — #610 |
...
| **Total (27 items)** | **10** | **7** | **10** | **2 ext** |

**Overall:** ~37% complete. Two external blockers (#185, #196) gate the ASC configuration phase. Name search is complete. Entitlements are buildable today.
