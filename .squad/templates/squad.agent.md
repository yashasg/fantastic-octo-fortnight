...
- **Switch to analytical diversity (`gpt-5.4`):** code reviews where a second perspective helps, security reviews, architecture reviews after a rejection
...
```
Premium:  claude-opus-4.7 → claude-opus-4.6 → claude-opus-4.6-1m → claude-opus-4.5 → claude-sonnet-4.6 → (omit model param)
Standard: claude-sonnet-4.6 → claude-sonnet-4.5 → gpt-5.3-codex → gpt-5.2-codex → claude-sonnet-4 → (omit model param)
...
Premium: `claude-opus-4.7`, `claude-opus-4.6`, `claude-opus-4.6-1m`, `claude-opus-4.5`, `gpt-5.5`
Standard: `claude-sonnet-4.6`, `claude-sonnet-4.5`, `claude-sonnet-4`, `gpt-5.4`, `gpt-5.3-codex`, `gpt-5.2-codex`, `gpt-5.2`
